<div class="entries">
    <nav>
        <x-entries.link :payday="auth()->user()->payday()->older()">
            ...
            <x-entries.date-label :payday="auth()->user()->payday()->older()" />
        </x-entries.link>

        <x-entries.date-label :payday="auth()->user()->payday()" />

        <x-entries.link :payday="auth()->user()->payday()->newer()">
            <x-entries.date-label :payday="auth()->user()->payday()->newer()" />
    ...
    <div class="entries-list">
        @if(auth()->user()->payday()->entries->isNotEmpty())
            <div class="header">Entries for this date</div>

            <ul>
                @foreach(auth()->user()->payday()->sortedEntries() as $entry)
