<div class="w-1/12">
    <button wire:click="$toggle('modal')" class="cursor-pointer mt-4 transform transition-transform hover:scale-110" type="button">
        @include('plus')
    </button>
    ...
    <x-jet-dialog-modal wire:model="modal">
        ...
        <x-slot name="content">
            ...
            <div>
                ...
                <x-jet-input id="new-amount" class="block mt-1 w-full" type="number" step="0.01" wire:model="amount" :value="old('amount')" required autofocus />
